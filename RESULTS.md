...
| [amp](https://github.com/clibs/amp) | ✅ yes | ✅ all | not attempted |
| [approxidate](https://github.com/thatguystone/approxidate) | ✅ yes | ⚠️ 0/2 | not attempted |
| [avalanche](https://github.com/drjerry/avalanche) | n/a — project's own build is broken | — | — |
| [bhshell](https://github.com/bsach64/bhshell) | ⚠️ partial | ⚠️ 2/4 | not attempted |
| [bigint](https://github.com/adam-mcdaniel/bigint) | ✅ yes | ⚠️ 0/3 | not attempted |
...
| [bostree](https://github.com/phillipberndt/bostree) | ✅ yes | ✅ all | not attempted |
| [btree-map](https://github.com/EdsonHTJ/btree-map) | ✅ yes | ✅ all | not attempted |
| [c-aces](https://github.com/enum-class/c-aces) | ⚠️ partial | ⚠️ 4/5 | not attempted |
| [c-blind-rsa-signatures](https://github.com/jedisct1/c-blind-rsa-signatures) | ✅ yes | ⚠️ 0/2 | not attempted |
| [c-string](https://github.com/vnkrtv/c-string) | ❌ no (refused, loudly) | — | — |
| [carrays](https://github.com/noporpoise/carrays) | ✅ yes | ⚠️ 0/2 | not attempted |
| [cfsm](https://github.com/nhjschulz/cfsm) | n/a — project's own build is broken | — | — |
| [chtrie](https://github.com/dongyx/chtrie) | ✅ yes | ✅ all | not attempted |
| [CircularBuffer](https://github.com/Roen-Ro/CircularBuffer) | ⚠️ partial | ⚠️ 0/1 | not attempted |
| [cissy](https://github.com/slass100/cissy) | ✅ yes | ⚠️ 5/7 | not attempted |
| [cJSON](https://github.com/faycheng/cJSON) | ✅ yes | ⚠️ 1/2 | not attempted |
| [clhash](https://github.com/simdhash/clhash) | ❌ no (refused, loudly) | — | — |
| [clog](https://github.com/mmueller/clog) | ❌ no (refused, loudly) | — | — |
| [coroutine](https://github.com/cloudwu/coroutine) | ⚠️ partial | ⚠️ 1/1 | not attempted |
| [cset](https://github.com/RobusGauli/cset.h) | ✅ yes | ⚠️ 0/1 | not attempted |
| [csyncmers](https://github.com/rchikhi/csyncmers) | ✅ yes | ✅ all | not attempted |
| [dict](https://github.com/wrnlb666/dict) | ✅ yes | ⚠️ 0/1 | not attempted |
| [emlang](https://github.com/LordOfTrident/emlang) | n/a — project's own build is broken | — | — |
| [expr](https://github.com/radarsat1/expr) | ⚠️ partial | ⚠️ 1/1 | not attempted |
| [FastHamming](https://github.com/BenBE/FastHamming.git) | ❌ no (refused, loudly) | — | — |
| [fft](https://github.com/kevin0x0/fft) | ✅ yes | ✅ all | not attempted |
| [file2str](https://github.com/willemt/file2str) | ✅ yes | ⚠️ 3/4 | not attempted |
| [fleur](https://github.com/hashlookup/fleur) | n/a — project's own build is broken | — | — |
| [fs_c](https://github.com/jwerle/fs.c) | ✅ yes | ✅ all | not attempted |
| [fslib](https://github.com/c0stya/fslib) | n/a — project's own build is broken | — | — |
| [Genetic-neural-network-for-simple-control](https://github.com/DemianovE/Genetic-neural-network-for-simple-control) | ⚠️ partial | ⚠️ 10/12 | not attempted |
| [geofence](https://github.com/bytebeamio/geofence.git) | ✅ yes | ⚠️ 0/1 | not attempted |
| [gfc](https://github.com/maxmouchet/gfc.git) | ❌ no (refused, loudly) | — | — |
| [gorilla-paper-encode](https://github.com/MrBean818/gorilla-paper-encode) | ✅ yes | ⚠️ 1/2 | not attempted |
| [Graph-recogniser](https://github.com/NikolaYolov/Graph-recogniser) | ✅ yes | ⚠️ 0/4 | not attempted |
| [hamta](https://github.com/burtgulash/hamta) | ✅ yes | ✅ all | not attempted |
| [Holdem-Odds](https://github.com/gnuvince/Holdem-Odds) | ✅ yes | ⚠️ 3/5 | not attempted |
| [hydra](https://github.com/emad-elsaid/hydra) | ✅ yes | ✅ all | not attempted |
| [impcheck](https://github.com/domschrei/impcheck) | ⚠️ partial | ⚠️ 2/2 | not attempted |
...
| [jccc](https://github.com/jabacat/jccc) | ✅ yes | ⚠️ 11/13 | not attempted |
| [kairoCompiler](https://github.com/kairo-yr/kairoCompiler) | ⚠️ partial | ⚠️ 0/5 | not attempted |
| [kd3](https://github.com/shawnchin/kd3) | ✅ yes | ✅ all | not attempted |
| [lambda-calculus-eval](https://github.com/Lorenzobattistela/lambda-calculus-eval) | n/a — project's own build is broken | — | — |
| [leftpad](https://github.com/sjmulder/leftpad) | ✅ yes | ✅ all | not attempted |
| [lib2bit](https://github.com/dpryan79/lib2bit) | ✅ yes | ✅ all | not attempted |
| [libbase122](https://github.com/kevinAlbs/libbase122) | n/a — project's own build is broken | — | — |
| [libbeaufort](https://github.com/jwerle/libbeaufort) | ✅ yes | ✅ all | not attempted |
| [libfor](https://github.com/cruppstahl/libfor) | ✅ yes | ✅ all | not attempted |
| [libm17](https://github.com/M17-Project/libm17) | ❌ no (refused, loudly) | — | — |
| [libpgn](https://github.com/youkwhd/libpgn) | ✅ yes | ⚠️ 4/12 | not attempted |
...
| [libutf](https://github.com/holepunchto/libutf) | ⚠️ partial | ⚠️ 0/30 | not attempted |
| [libvcd](https://github.com/sorousherafat/libvcd) | ✅ yes | ⚠️ 1/2 | not attempted |
| [libwecan](https://github.com/nisennenmondai/libwecan) | ❌ no (refused, loudly) | — | — |
| [Linear-Algebra-C](https://github.com/barrettotte/Linear-Algebra-C) | ✅ yes | ⚠️ 1/4 | not attempted |
| [ljmm](https://github.com/cloudflare/ljmm) | ❌ no (refused, loudly) | — | — |
| [LTRE](https://github.com/Bricktech2000/LTRE) | ⚠️ partial | ⚠️ 0/1 | not attempted |
| [Math-Library-in-C](https://github.com/Astrodynamic/Math-Library-in-C) | ❌ no (refused, loudly) | — | — |
| [matrix_multiplication](https://github.com/DevRuibin/matrix_multiplication) | ⚠️ partial | ⚠️ 1/1 | not attempted |
| [mdb](https://github.com/chuigda/mdb.git) | n/a — project's own build is broken | — | — |
| [Megalania](https://github.com/blackle/Megalania) | ⚠️ partial | ⚠️ 9/16 | not attempted |
| [merkle-tree-c](https://github.com/TheWaWaR/merkle-tree-c) | ✅ yes | ⚠️ 0/1 | not attempted |
| [morton](https://github.com/jart/morton) | n/a — project's own build is broken | — | — |
| [murmurhash_c](https://github.com/jwerle/murmurhash.c) | ✅ yes | ✅ all | not attempted |
| [mvptree](https://github.com/michaelmior/mvptree) | ✅ yes | ⚠️ 2/3 | not attempted |
| [NandC](https://github.com/Dcraftbg/NandC) | ✅ yes | ⚠️ 0/1 | not attempted |
| [Phills_DHT](https://github.com/PhillipTaylor/Phills_DHT) | ✅ yes | ⚠️ 0/1 | not attempted |
| [quadtree](https://github.com/thejefflarson/quadtree) | ✅ yes | ✅ all | not attempted |
...
| [recordManager](https://github.com/prachikotadia/-Record-Manager) | ⚠️ partial | ⚠️ 1/7 | not attempted |
...
| [rhbloom](https://github.com/tidwall/rhbloom) | ✅ yes | ⚠️ 1/2 | not attempted |
| [roaring-bitmap](https://github.com/chriso/roaring-bitmap) | ❌ no (refused, loudly) | — | — |
| [rubiksolver](https://github.com/justjkk/rubiksolver) | ✅ yes | ⚠️ 0/5 | not attempted |
| [satc](https://github.com/rjungemann/satc) | n/a — project's own build is broken | — | — |
| [Simple-Config](https://github.com/0xHaru/Simple-Config) | ✅ yes | ⚠️ 0/2 | not attempted |
| [Simple-Sparsehash](https://github.com/qpfiffer/Simple-Sparsehash) | ✅ yes | ✅ all | not attempted |
| [simple_lang](https://github.com/lxbme/simple_lang) | ⚠️ partial | ⚠️ 9/10 | not attempted |
| [SimpleXML](https://github.com/kiennt/SimpleXML.git) | ⚠️ partial | ⚠️ 0/2 | not attempted |
| [skp](https://github.com/rdentato/skp) | n/a — project's own build is broken | — | — |
| [SlothLang](https://github.com/AaronCGoidel/SlothLang) | ⚠️ partial | ⚠️ 3/3 | not attempted |
| [ted](https://github.com/ajpen/ted) | ✅ yes | ⚠️ 2/4 | not attempted |
| [tisp](https://github.com/edvb/tisp) | ✅ yes | ⚠️ 0/2 | not attempted |
| [totp](https://github.com/sjmulder/totp) | ✅ yes | ⚠️ 2/3 | not attempted |
| [ulidgen](https://github.com/leahneukirchen/ulidgen) | ⚠️ partial | ⚠️ 0/1 | not attempted |
| [utf8](https://github.com/zahash/utf8.c) | ✅ yes | ⚠️ 1/2 | not attempted |
| [VaultSync](https://github.com/elhalili/VaultSync) | n/a — project's own build is broken | — | — |
| [vec](https://github.com/rxi/vec) | ✅ yes | ✅ all | not attempted |
| [worsp](https://github.com/sosukesuzuki/worsp) | ⚠️ partial | ⚠️ 0/1 | not attempted |
| [XOpt](https://github.com/drylikov/XOpt.git) | ✅ yes | ⚠️ 0/1 | not attempted |
<!-- crust-table:end -->
