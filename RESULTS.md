...
| [amp](https://github.com/clibs/amp) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 2/2 | C++ — · Rust — | ❌ | 20 | 47 | −27 | 9.7% |
| [approxidate](https://github.com/thatguystone/approxidate) | C++ ✅ · Rust ✅ | C++ 1/2 · Rust 0/2 | C++ — · Rust — | ❌ | 188 | 441 | −253 | 8.9% |
| [avalanche](https://github.com/drjerry/avalanche) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [bhshell](https://github.com/bsach64/bhshell) | C++ ⚠️ · Rust ⚠️ | C++ 4/4 · Rust 2/4 | C++ — · Rust — | ❌ | 245 | 304 | −59 | 11.9% |
| [bigint](https://github.com/adam-mcdaniel/bigint) | C++ ✅ · Rust ✅ | C++ 3/3 · Rust 0/3 | C++ — · Rust — | — | 0 | 478 | −478 | 4.4% |
| [bitset](https://github.com/abenhlal/bitset) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [blt](https://github.com/blynn/blt) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [bostree](https://github.com/phillipberndt/bostree) | C++ ✅ · Rust ✅ | C++ 2/3 · Rust 3/3 | C++ — · Rust — | ❌ | 368 | 501 | −133 | 13.3% |
| [btree-map](https://github.com/EdsonHTJ/btree-map) | C++ ✅ · Rust ✅ | C++ 1/2 · Rust 2/2 | C++ — · Rust — | — | 178 | 526 | −348 | 15.6% |
| [c-aces](https://github.com/enum-class/c-aces) | C++ ⚠️ · Rust ⚠️ | C++ 5/5 · Rust 4/5 | C++ — · Rust — | — | 330 | 287 | +43 | 8.1% |
| [c-blind-rsa-signatures](https://github.com/jedisct1/c-blind-rsa-signatures) | C++ ✅ · Rust ✅ | C++ 1/2 · Rust 0/2 | C++ — · Rust — | — | 137 | 3,101 | −2,964 | 20.1% |
| [c-string](https://github.com/vnkrtv/c-string) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [carrays](https://github.com/noporpoise/carrays) | C++ ✅ · Rust ✅ | C++ 1/2 · Rust 0/2 | C++ — · Rust — | ❌ | 349 | 1,819 | −1,470 | 9.1% |
| [cfsm](https://github.com/nhjschulz/cfsm) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [chtrie](https://github.com/dongyx/chtrie) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 1/1 | C++ — · Rust — | — | 66 | 76 | −10 | 9.0% |
| [CircularBuffer](https://github.com/Roen-Ro/CircularBuffer) | C++ ⚠️ · Rust ⚠️ | C++ 0/1 · Rust 0/1 | C++ — · Rust — | ❌ | 102 | 75 | +27 | 7.4% |
| [cissy](https://github.com/slass100/cissy) | C++ ✅ · Rust ✅ | C++ 4/7 · Rust 5/7 | C++ — · Rust — | ❌ | 330 | 781 | −451 | 15.2% |
| [cJSON](https://github.com/faycheng/cJSON) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 1/2 | C++ ✅ · Rust — | ❌ | 478 | 1,371 | −893 | 11.8% |
| [clhash](https://github.com/simdhash/clhash) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [clog](https://github.com/mmueller/clog) | C++ ✅ · Rust ❌ | C++ 0/1 · Rust 0/0 | C++ — · Rust — | — | 10 | 0 | +10 | — |
| [coroutine](https://github.com/cloudwu/coroutine) | C++ ⚠️ · Rust ⚠️ | C++ 1/1 · Rust 1/1 | C++ — · Rust — | — | 1 | 19 | −18 | 14.7% |
| [cset](https://github.com/RobusGauli/cset.h) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 0/1 | C++ — · Rust — | — | 14,564 | 25 | +14,539 | 2.9% |
| [csyncmers](https://github.com/rchikhi/csyncmers) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 2/2 | C++ — · Rust — | — | 10 | 92 | −82 | 5.1% |
| [dict](https://github.com/wrnlb666/dict) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 0/1 | C++ — · Rust — | — | 352 | 0 | +352 | — |
| [emlang](https://github.com/LordOfTrident/emlang) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [expr](https://github.com/radarsat1/expr) | C++ ✅ · Rust ⚠️ | C++ 1/2 · Rust 1/1 | C++ — · Rust — | — | 360 | 28 | +332 | 6.2% |
| [FastHamming](https://github.com/BenBE/FastHamming.git) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [fft](https://github.com/kevin0x0/fft) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 1/1 | C++ — · Rust — | — | 78 | 106 | −28 | 4.8% |
| [file2str](https://github.com/willemt/file2str) | C++ ✅ · Rust ✅ | C++ 4/4 · Rust 3/4 | C++ — · Rust — | ❌ | 82 | 174 | −92 | 9.8% |
| [fleur](https://github.com/hashlookup/fleur) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [fs_c](https://github.com/jwerle/fs.c) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 1/1 | C++ — · Rust — | — | 1 | 52 | −51 | 11.2% |
| [fslib](https://github.com/c0stya/fslib) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [Genetic-neural-network-for-simple-control](https://github.com/DemianovE/Genetic-neural-network-for-simple-control) | C++ ⚠️ · Rust ⚠️ | C++ 12/12 · Rust 10/12 | C++ — · Rust — | — | 644 | 803 | −159 | 13.1% |
| [geofence](https://github.com/bytebeamio/geofence.git) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 0/1 | C++ — · Rust — | — | 12 | 6 | +6 | 2.7% |
| [gfc](https://github.com/maxmouchet/gfc.git) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [gorilla-paper-encode](https://github.com/MrBean818/gorilla-paper-encode) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 1/2 | C++ ✅ · Rust — | — | 173 | 145 | +28 | 4.4% |
| [Graph-recogniser](https://github.com/NikolaYolov/Graph-recogniser) | C++ ✅ · Rust ✅ | C++ 4/4 · Rust 0/4 | C++ ✅ · Rust — | — | 141 | 419 | −278 | 14.6% |
| [hamta](https://github.com/burtgulash/hamta) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 1/1 | C++ — · Rust — | — | 145 | 34 | +111 | 9.6% |
| [Holdem-Odds](https://github.com/gnuvince/Holdem-Odds) | C++ ✅ · Rust ✅ | C++ 4/5 · Rust 3/5 | C++ — · Rust — | — | 64 | 95 | −31 | 6.4% |
| [hydra](https://github.com/emad-elsaid/hydra) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 1/1 | C++ — · Rust — | — | 71 | 148 | −77 | 14.3% |
| [impcheck](https://github.com/domschrei/impcheck) | C++ ⚠️ · Rust ⚠️ | C++ 2/2 · Rust 2/2 | C++ — · Rust — | ❌ | 0 | 4 | −4 | 16.0% |
...
| [jccc](https://github.com/jabacat/jccc) | C++ ✅ · Rust ✅ | C++ 12/13 · Rust 11/13 | C++ — · Rust — | ❌ | 226 | 794 | −568 | 11.6% |
| [kairoCompiler](https://github.com/kairo-yr/kairoCompiler) | C++ ✅ · Rust ⚠️ | C++ 3/10 · Rust 0/5 | C++ — · Rust — | ❌ | 193 | 263 | −70 | 12.2% |
| [kd3](https://github.com/shawnchin/kd3) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 2/2 | C++ ✅ · Rust — | ❌ | 179 | 281 | −102 | 9.9% |
| [lambda-calculus-eval](https://github.com/Lorenzobattistela/lambda-calculus-eval) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [leftpad](https://github.com/sjmulder/leftpad) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 2/2 | C++ ✅ · Rust ✅ | ❌ | 16 | 41 | −25 | 9.9% |
| [lib2bit](https://github.com/dpryan79/lib2bit) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 1/1 | C++ — · Rust — | — | 432 | 598 | −166 | 8.9% |
| [libbase122](https://github.com/kevinAlbs/libbase122) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [libbeaufort](https://github.com/jwerle/libbeaufort) | C++ ✅ · Rust ✅ | C++ 3/3 · Rust 3/3 | C++ — · Rust — | ❌ | 37 | 65 | −28 | 6.9% |
| [libfor](https://github.com/cruppstahl/libfor) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 2/2 | C++ ✅ · Rust — | — | 55 | 14,698 | −14,643 | 7.2% |
| [libm17](https://github.com/M17-Project/libm17) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [libpgn](https://github.com/youkwhd/libpgn) | C++ ✅ · Rust ✅ | C++ 11/12 · Rust 4/12 | C++ — · Rust — | ❌ | 339 | 678 | −339 | 10.2% |
| [libpsbt](https://github.com/jb55/libpsbt) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [libqueue](https://github.com/resyfer/libqueue) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [libtinyfseq](https://github.com/Cryptkeeper/libtinyfseq) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [libutf](https://github.com/holepunchto/libutf) | C++ ⚠️ · Rust ✅ | C++ 0/27 · Rust 0/36 | C++ — · Rust — | — | 122 | 0 | +122 | 0.0% |
| [libvcd](https://github.com/sorousherafat/libvcd) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 1/2 | C++ ✅ · Rust — | ❌ | 42 | 111 | −69 | 9.1% |
| [libwecan](https://github.com/nisennenmondai/libwecan) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [Linear-Algebra-C](https://github.com/barrettotte/Linear-Algebra-C) | C++ ✅ · Rust ✅ | C++ 4/4 · Rust 1/4 | C++ ✅ · Rust — | — | 499 | 1,055 | −556 | 11.4% |
| [ljmm](https://github.com/cloudflare/ljmm) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [LTRE](https://github.com/Bricktech2000/LTRE) | C++ ✅ · Rust ⚠️ | C++ 1/2 · Rust 0/1 | C++ — · Rust — | ❌ | 476 | 0 | +476 | — |
| [Math-Library-in-C](https://github.com/Astrodynamic/Math-Library-in-C) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [matrix_multiplication](https://github.com/DevRuibin/matrix_multiplication) | C++ ⚠️ · Rust ⚠️ | C++ 1/1 · Rust 1/1 | C++ — · Rust — | ❌ | 2 | 12 | −10 | 10.7% |
| [mdb](https://github.com/chuigda/mdb.git) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [Megalania](https://github.com/blackle/Megalania) | C++ ⚠️ · Rust ⚠️ | C++ 16/16 · Rust 9/16 | C++ — · Rust — | ❌ | 451 | 866 | −415 | 12.5% |
| [merkle-tree-c](https://github.com/TheWaWaR/merkle-tree-c) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 0/1 | C++ — · Rust — | — | 25 | 405 | −380 | 1.8% |
| [morton](https://github.com/jart/morton) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [murmurhash_c](https://github.com/jwerle/murmurhash.c) | C++ ✅ · Rust ✅ | C++ 3/3 · Rust 3/3 | C++ — · Rust — | ❌ | 11 | 73 | −62 | 9.7% |
| [mvptree](https://github.com/michaelmior/mvptree) | C++ ✅ · Rust ✅ | C++ 3/3 · Rust 2/3 | C++ — · Rust — | ❌ | 1,004 | 1,738 | −734 | 13.5% |
| [NandC](https://github.com/Dcraftbg/NandC) | C++ ✅ · Rust ✅ | C++ 0/1 · Rust 0/1 | C++ — · Rust — | — | 0 | 33 | −33 | 5.4% |
| [Phills_DHT](https://github.com/PhillipTaylor/Phills_DHT) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 0/1 | C++ — · Rust — | — | 27 | 93 | −66 | 17.0% |
| [quadtree](https://github.com/thejefflarson/quadtree) | C++ ✅ · Rust ✅ | C++ 5/5 · Rust 5/5 | C++ ✅ · Rust ✅ | ❌ | 200 | 425 | −225 | 14.2% |
| [razz_simulation](https://github.com/eus/razz_simulation) | C++ ✅ · Rust ❌ | C++ 0/1 · Rust 0/0 | C++ — · Rust — | — | 11 | 0 | +11 | — |
| [rbtree-lab](https://github.com/jwowo/rbtree-lab) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [recordManager](https://github.com/prachikotadia/-Record-Manager) | C++ ⚠️ · Rust ⚠️ | C++ 7/7 · Rust 1/7 | C++ — · Rust — | ❌ | 1,190 | 3,281 | −2,091 | 14.8% |
...
| [rhbloom](https://github.com/tidwall/rhbloom) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 1/2 | C++ — · Rust — | ❌ | 100 | 244 | −144 | 9.4% |
| [roaring-bitmap](https://github.com/chriso/roaring-bitmap) | C++ ❌ · Rust ❌ | C++ 0/0 · Rust 0/0 | C++ — · Rust — | — | 0 | 0 | 0 | — |
| [rubiksolver](https://github.com/justjkk/rubiksolver) | C++ ✅ · Rust ✅ | C++ 2/5 · Rust 0/5 | C++ — · Rust — | ❌ | 379 | 871 | −492 | 12.6% |
| [satc](https://github.com/rjungemann/satc) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [Simple-Config](https://github.com/0xHaru/Simple-Config) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 0/2 | C++ ✅ · Rust — | — | 117 | 462 | −345 | 12.9% |
| [Simple-Sparsehash](https://github.com/qpfiffer/Simple-Sparsehash) | C++ ✅ · Rust ✅ | C++ 1/2 · Rust 2/2 | C++ — · Rust — | — | 91 | 449 | −358 | 8.2% |
| [simple_lang](https://github.com/lxbme/simple_lang) | C++ ✅ · Rust ⚠️ | C++ 11/11 · Rust 9/10 | C++ — · Rust — | ❌ | 263 | 550 | −287 | 14.5% |
| [SimpleXML](https://github.com/kiennt/SimpleXML.git) | C++ ⚠️ · Rust ⚠️ | C++ 1/2 · Rust 0/2 | C++ — · Rust — | ❌ | 137 | 238 | −101 | 13.6% |
| [skp](https://github.com/rdentato/skp) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [SlothLang](https://github.com/AaronCGoidel/SlothLang) | C++ ⚠️ · Rust ⚠️ | C++ 3/3 · Rust 3/3 | C++ — · Rust — | ❌ | 13 | 52 | −39 | 8.1% |
| [ted](https://github.com/ajpen/ted) | C++ ⚠️ · Rust ✅ | C++ 3/3 · Rust 2/4 | C++ — · Rust — | ❌ | 339 | 732 | −393 | 11.3% |
| [tisp](https://github.com/edvb/tisp) | C++ ✅ · Rust ✅ | C++ 0/2 · Rust 0/2 | C++ — · Rust — | ❌ | 621 | 2,804 | −2,183 | 12.1% |
| [totp](https://github.com/sjmulder/totp) | C++ ✅ · Rust ✅ | C++ 2/3 · Rust 2/3 | C++ — · Rust — | ❌ | 23 | 225 | −202 | 7.0% |
| [ulidgen](https://github.com/leahneukirchen/ulidgen) | C++ ⚠️ · Rust ⚠️ | C++ 1/1 · Rust 0/1 | C++ — · Rust — | — | 1 | 39 | −38 | 10.8% |
| [utf8](https://github.com/zahash/utf8.c) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 1/2 | C++ ✅ · Rust — | ❌ | 75 | 708 | −633 | 16.9% |
| [VaultSync](https://github.com/elhalili/VaultSync) | n/a — project build broken | — | — | — | 0 | 0 | 0 | — |
| [vec](https://github.com/rxi/vec) | C++ ✅ · Rust ✅ | C++ 2/2 · Rust 2/2 | C++ ✅ · Rust — | ❌ | 885 | 2,101 | −1,216 | 16.2% |
| [worsp](https://github.com/sosukesuzuki/worsp) | C++ ⚠️ · Rust ⚠️ | C++ 0/1 · Rust 0/1 | C++ — · Rust — | ❌ | 1,087 | 0 | +1,087 | — |
| [XOpt](https://github.com/drylikov/XOpt.git) | C++ ✅ · Rust ✅ | C++ 1/1 · Rust 0/1 | C++ — · Rust — | — | 135 | 616 | −481 | 6.4% |
